      ...
      <div className="container-fluied bgsec my-3">
        ...
        <div className="row  d-flex justify-content-between">
                  <div className="col-12 col-sm-12 col-md-6 d-flex d-flex justify-content-between align-items-center  my-3">
                    <h4 className="align-items-center">Sign Up For Newsletter</h4>
                    <p className=" align-items-center mt-3">Join our email list and be the first to hear about deals</p>
                  </div>
